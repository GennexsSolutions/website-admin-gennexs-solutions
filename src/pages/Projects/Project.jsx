...
function Project() {
  ...
  const getData = async () => {
    axios.get('https://api-website-admin-gennexsolutions.onrender.com/project/getData')
      .then((res) => {
  ...
  const handleOk = async (event) => {
    ...
    try {
      ...
      formDataTosend.append("description", formData.discription);
      formDataTosend.append("name", formData.name);
      formDataTosend.append("image", formData.image);
      const headers = {
        'Content-Type': 'multipart/form-data',
      };
      const response = await axios.post('https://api-website-admin-gennexsolutions.onrender.com/project/insertproject', formData, { headers });
  ...
  const handleDelete = async () => {
    try {
        ...
        await axios.delete(
            `https://api-website-admin-gennexsolutions.onrender.com/project/delete/${deleteItemId}`
        );
    ...
    <div>
      ...
      >
        <Form layout="vertical"
          ...
          <Form.Item label="ລາຍລະອຽດ" name="discription" rules={[{ required: true }]}>
            <Input />
          </Form.Item>
          <Form.Item label="ຊື່ຂໍ້ມູນ" name="name" rules={[{ required: true }]}>
            <Input />
          </Form.Item>
